  ...
  return (
    ...
    >
      ...
      >
        {items.map((item) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-2xl bg-gradient-to-b from-gray-900 to-gray-800 px-8 py-6 md:w-[450px]"
            key={item.name || item} // fallback for string items
          >
            <blockquote>
              <div
                aria-hidden="true"
